...
import 'package:elibrary/pages/home/videos/video_detail.dart';
...
class VideoCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        final route = MaterialPageRoute(builder: (context) => VideoDetail());
              ...
              Container(
                ...
                child: ClipRRect(
                  ...
                  child: AspectRatio(
                    aspectRatio: 16 / 9,
                    child: Image.network(
                      'http://www.elibrary-rule.com/assets/images/audios/thumb/1722237598qCQydoDdQJ.jpg',
